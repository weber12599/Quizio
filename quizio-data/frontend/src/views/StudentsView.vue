  ...
  <div class="students-container">
    <el-card>
      ...
      <el-table :data="students" v-loading="loading" border style="width: 100%">
        ...
        <el-table-column prop="admission_year" label="Admission Year" width="150" />
    ...
    <el-dialog 
      ...
      width="500px"
    >
      <el-form :model="formData" label-width="120px" @keyup.enter="submitForm">
        ...
        <el-form-item label="Password" :required="dialogType === 'add'">
          <el-input 
            ...
            type="password" 
            show-password 
            :placeholder="dialogType === 'edit' ? 'Leave blank to keep unchanged' : ''"
          />
        </el-form-item>
        <el-form-item label="Email">
          <el-input v-model="formData.email" placeholder="student@example.com" />
        </el-form-item>
        <el-form-item label="Admission Year">
          <el-input-number v-model="formData.admission_year" :controls="false" placeholder="112" style="width: 100%;" />
        </el-form-item>
        <el-form-item label="Class">
